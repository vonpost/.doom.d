...
(defgroup doom-solaris8-light-theme nil
  "Options for the `doom-solaris8-light' theme."
  :group 'doom-themes)

(defcustom doom-solaris8-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-solaris8-light-theme
  :type 'boolean)

(defcustom doom-solaris8-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-solaris8-light-theme
  :type 'boolean)

(defcustom doom-solaris8-light-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-solaris8-light
  ...
  ((bg         '("#adb5c6" "white"   "white"        ))
   ...
   (modeline-fg-alt          (doom-blend
                              violet base4
                              (if doom-solaris8-light-brighter-modeline 0.5 0.2)))
   (modeline-bg              (if doom-solaris8-light-brighter-modeline
                                 (doom-darken base2 0.05)
                               base1))
   (modeline-bg-alt          (if doom-solaris8-light-brighter-modeline
   ...
   (-modeline-pad
    (when doom-solaris8-light-padded-modeline
      (if (integerp doom-solaris8-light-padded-modeline) doom-solaris8-light-padded-modeline 4))))

  ;;;; Base theme face overrides
  (((font-lock-comment-face &override)
    :background (if doom-solaris8-light-brighter-comments base0 'unspecified))
   ...
   (mode-line-emphasis
    :foreground (if doom-solaris8-light-brighter-modeline base8 highlight))
   ...
   ;;;; doom-modeline
   (doom-modeline-bar :background (if doom-solaris8-light-brighter-modeline modeline-bg highlight))
   ;;;; ediff <built-in>
...
;;; doom-solaris8-light-theme.el ends here
